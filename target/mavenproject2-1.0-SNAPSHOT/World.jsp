<%-- 
    Document   : World
    Created on : 7 Oct, 2019, 11:47:46 AM
    Author     : adity
--%>
...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a  href="World" class="active">World</a></li>
        ...
        String[] Link;
            ...
            World = new String[((String[])request.getAttribute("WorldTitle")).length];
            World = ((String[])request.getAttribute("WorldTitle"));
            
            Desc = new String[((String[])request.getAttribute("WorldDesc")).length];
            Desc = ((String[])request.getAttribute("WorldDesc"));
            
            Image = new String[((String[])request.getAttribute("Worldimg")).length];
            Image = ((String[])request.getAttribute("Worldimg"));
            
            pubDate = new Date[((Date[])request.getAttribute("Worlddate")).length];
            pubDate = ((Date[])request.getAttribute("Worlddate"));
         ...
         <div class=" section lb container center-block aligncenter">
             <div class="issuse-wrap2 clearfix aligncenter">
                 <h1 class="header_style_01 h1">World</h1>
