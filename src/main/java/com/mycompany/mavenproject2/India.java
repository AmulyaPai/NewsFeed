...
public class India extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String titl[]=new String[19];
            String des[]=new String[19];
            String links[] = new String[19];
            //String aut[]=new String[20];
            Date dat[]=new Date[19];
            ...
            request.setAttribute("IndiaTitle", titl);
            request.setAttribute("IndiaDesc", des);
            request.setAttribute("Indiaimg", img);
            request.setAttribute("Indiadate", dat);
            request.setAttribute("WorldLink", links);
                   
            
            request.getRequestDispatcher("/India.jsp").forward(request, response);
