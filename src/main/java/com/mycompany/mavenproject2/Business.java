...
public class Business extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        int i = 0;
        try {
            feed = (SyndFeed) ff.retrieveFeed(new URL("https://timesofindia.indiatimes.com/rssfeeds/1898055.cms"));
            ...
            request.setAttribute("BusinessTitle", titl);
            request.setAttribute("BusinessDesc", des);
            request.setAttribute("Businessimg", img);
            request.setAttribute("Businessdate", dat);
