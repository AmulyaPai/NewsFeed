...
public class Entertainment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int i = 0;
        try {
            feed = (SyndFeed) ff.retrieveFeed(new URL("https://timesofindia.indiatimes.com/rssfeeds/1081479906.cms"));
            ...
            request.setAttribute("EntertainmentTitle", titl);
            request.setAttribute("EntertainmentDesc", des);
            request.setAttribute("Entertainmentimg", img);
            request.setAttribute("WorldLink", links);
            request.setAttribute("Entertainmentdate", dat);
