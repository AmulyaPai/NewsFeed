...
public class Environment extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       response.setContentType("text/html;charset=UTF-8");
        ...
        int i = 0;
        try {
            feed = (SyndFeed) ff.retrieveFeed(new URL("https://timesofindia.indiatimes.com/rssfeeds/2647163.cms"));
            ...
            request.setAttribute("EnvironmentTitle", titl);
            request.setAttribute("EnvironmentDesc", des);
            request.setAttribute("Environmentimg", img);
            request.setAttribute("Environmentdate", dat);
